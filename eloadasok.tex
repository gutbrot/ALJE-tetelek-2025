...
\begin{document}
	...
	\begin{center}
		\includegraphics[width=90mm]{mag_abra}
	\end{center}
	...
	\end{theorem}
	\begin{center}
		\includegraphics[width=100mm]{sprague-grundy_biz}
	\end{center}
	...
	\begin{definition}{Százlábú játék}{}
		\begin{itemize}
			\item lépéskor: kiszál/játszik tovább
			\item a racionális döntés kiszállni
		\end{itemize}
	\end{definition}
	...
	\section{Előadás}
	\begin{definition}{}{}
		Strat. játék esetén az i-dik játékos maximin stratégiája egy olyan $\sigma_1 \in \Delta$ kevert stratégiája, amire $min u_i(\sigma_i, s_{-i})$
	\end{definition}
	...
	\begin{observation}{}{}
		\begin{enumerate}
			\item A mximin stratégiaválasztása általában nem kNE
			\item Mindig van mximin stratégia, és ez egy Lineáris Programozási feladat megoldásával kapható
		\end{enumerate}
	\end{observation}
	...
	\begin{definition}{Biztonsági szint}{}

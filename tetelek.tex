...
\begin{observation}{}
    ...
    \begin{itemize}
        \item független halmaz
        \item $\forall$ nem II-esből vezet él I-esbe
    \end{itemize}
\end{observation}
...
\begin{definition}{Nyerő stratégia}
    Nyerő egy stratégia, ha őt követve mindig nyerni tudunk, akármit is lépjen közben a másik játékos. A következő tétel a kombinatorikus játékelmélet alaptételének tekinthető. A bizonyítás módszere a bevezető gondolatmenet általánosítása, a visszafejtés (angolul backward tracking). 
\end{definition}

\begin{definition}{Mag}
    G irányított gráf magja a csúcsok olyanf ftn. M részhalmaza, amibe $\forall$ M-en kívüli csúcsból vezet él
\end{definition}
...
\begin{definition}{Grundy-számozás}
    G ir. gráf $g: V(G) \rightarrow \mathbb{N} $
\end{definition}

\begin{theorem}{}{}
    $J_1 + J_2$-ben II-es típusú $\Rightarrow g_1(V_1) = g_2(V_2)$
\end{theorem}
...
\begin{definition}{NIM-összeadás}{}
    $a \oplus b = c$ a NIM-összeg, ahol ezt úgy kapjuk, hogy a és b 2es számrendszerbeli alakját írásban összeadjuk, de a maradékot elfelejtjük 
\end{definition}
...
\begin{observation}{NIM-összeadás tulajdonságai}{}
    \begin{itemize}
        ...
        \item $c < a \oplus b \Rightarrow \exists a' < a: c =a' \oplus b$
    \end{itemize}
\end{observation}
